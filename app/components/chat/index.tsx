    ...
    <div className={cn(!feedbackDisabled && 'px-3.5', 'h-full')}>
      ...
      {!isHideSendInput && (
        <div className="fixed z-10 bottom-0 left-1/2 transform -translate-x-1/2 pc:ml-[122px] tablet:ml-[96px] mobile:ml-0 pc:w-[794px] tablet:w-[794px] max-w-full mobile:w-full px-3.5">
          {/* 外枠：濃い太枠＋影＋フォーカスで青リング */}
          <div
            className="
              group p-2 max-h-[180px] bg-white
              border-2 border-gray-400 rounded-2xl shadow
              overflow-y-auto
              transition
          ...
          >
            ...
            <Textarea
              className={`
                block w-full px-3 pr-[118px] py-2
                leading-5 max-h-none text-base text-gray-700
